...
| **Ambiente local** | `C:\Hidra` (ver `ceopet/apps/legado/_tools/setup_hidra.ps1`) |
...
- [ ] Tirar print da tela ? salvar em [`telas/`](telas/README.md) (nome: `RN-XXX-01-descricao.png`)
...
| `ceopet/apps/legado/_tools/analyze_hidra.py` | Inventário JSON |
...
Lista completa: `ceopet/docs/_tools/hidra_inventory.json` ? `menu_items`
