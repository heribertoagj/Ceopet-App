...
| Executável principal | `ceopet/apps/legado/Hidra/scd.exe` |
...
Inventário completo de campos: `ceopet/docs/_tools/hidra_inventory.json`.
...
- Dados em `ceopet/apps/legado/Hidra/` são ambiente demo/histórico Ceopet (emitente EXACTA / CEOPET).
