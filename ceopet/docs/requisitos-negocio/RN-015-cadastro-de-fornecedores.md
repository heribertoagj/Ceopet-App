...
- **RNG-015-01:** Grid **FORNECEDORES**, **CNPJ/CPF**, **TELEFONE**, **COD**; painel endereço, IE, Licença, Validade, Email.
  - **Evidência:** [RN-015-01-lista.png](../legado/telas/01-cadastros/06-fornecedores/RN-015-01-lista.png)

### Consulta / atalhos *(validado — F0024)*

- **RNG-015-02:** **Consulta** — visão cadastro somente leitura (**RETORNAR**); visão ampliada com **Financeiro** (vencidos, juros, total devedor) e grid **Compras** (ex.: **19528**, Concluido, 8.323,56).
  - **Evidência (cadastro):** [RN-015-05-consulta.png](../legado/telas/01-cadastros/06-fornecedores/RN-015-05-consulta.png)
  - **Evidência (financeiro + compras):** [RN-015-05b-consulta-financeiro-compras.png](../legado/telas/01-cadastros/06-fornecedores/RN-015-05b-consulta-financeiro-compras.png)
- **RNG-015-06:** **Notas Fiscais** — grid Compras com entrada **19528** (30/08/2016, Concluido, 8.323,56); Nota Fiscal **0** na demo.
  - **Evidência:** [RN-015-06-atalho-notas-fiscais.png](../legado/telas/01-cadastros/06-fornecedores/RN-015-06-atalho-notas-fiscais.png)
- **RNG-015-07:** **Pedidos de Compra** → alerta *Pedidos de Compras não Localizados.!!! Fornecedor (F0024)* quando não há pedido aberto na demo.
  - **Evidência:** [RN-015-07-atalho-pedidos-compra.png](../legado/telas/01-cadastros/06-fornecedores/RN-015-07-atalho-pedidos-compra.png)
- **RNG-015-08:** **Contas a Pagar** → grid **5 parcelas** **19528/1…5** (venc. set–nov/2016, 1.664,71–72, portador 2-Boleto, banco 001, status **N**); botões **Juros** / **Baixa**; resumo financeiro vencidos 8.323,56 + juros 97.663,10.
  - **Evidência:** [RN-015-08-atalho-contas-pagar.png](../legado/telas/01-cadastros/06-fornecedores/RN-015-08-atalho-contas-pagar.png)
...
- **RNG-015-03:** **Incluir** / **Alterar** abrem modal **Informação do Fornecedor** — duas seções **Cadastro** e **Dados do Fornecedor** *(tela única, sem abas)*; **SALVAR** / **CANCELAR** *(rótulos em vermelho = obrigatórios)*.
  - **Evidência:** [RN-015-02-incluir-cadastro.png](../legado/telas/01-cadastros/06-fornecedores/RN-015-02-incluir-cadastro.png)
...
- **RNG-015-03b — Seção Dados do Fornecedor:** **Fantasia**, **Contato** · **Telefone**, **Celular** · **Frete** (combo), **Transporte**, **Prazo**, **Obs**, **Cadastro** (data).
  - **Evidência:** [RN-015-03-incluir-dados-fornecedor.png](../legado/telas/01-cadastros/06-fornecedores/RN-015-03-incluir-dados-fornecedor.png)
- **RNG-015-03c — Defaults Incluir (demo):** Codigo **Automatico** · Tipo **Juridica** · Frete **Fornecedor (CIF)** · **Cadastro 19/06/2026** *(sessão 2026-06-19)* · demais vazios.
  - **Evidência:** [RN-015-02-incluir-cadastro.png](../legado/telas/01-cadastros/06-fornecedores/RN-015-02-incluir-cadastro.png)
- **RNG-015-03d:** **Alterar F0024** — mesma estrutura; **Empresa** exibida como **Nome** na Consulta/lista.
  - **Evidência:** [RN-015-04-alterar-f0024.png](../legado/telas/01-cadastros/06-fornecedores/RN-015-04-alterar-f0024.png)
