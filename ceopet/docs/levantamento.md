...
|-------|-------|---------------|
| Executável | `ceopet/apps/legado/Hidra/scd.exe` | Menus, mensagens, referências a 138 arquivos `.prg` |
| Bases DBF | `ceopet/apps/legado/Hidra/*.DBF` | 37 tabelas, schemas e dados demo Ceopet |
| Log de erro | `ceopet/apps/legado/Hidra/Error.log` | Stack xHarbour, módulos `scd.prg`, `scd1emi.prg` |
| Config DBU | `ceopet/apps/legado/Hidra/EMAGDBU.INI` | RDD DBFCDX, histórico de arquivos abertos |
| Plugin boletos | `ceopet/apps/legado/Hidra/Boleto/bplugin/` | Emissão bancária separada |
| Pastas operacionais | `Remessa/`, `Retorno/`, `Saidatxt/`, `Lixeira/` | Integração CNAB / arquivos fiscais |
| Script de análise | `ceopet/apps/legado/_tools/setup_hidra.ps1` | Setup local em `C:\Hidra` para executar o legado |
...
1. Extrair `Hidra.rar` e incluir fontes no repositório (ou pasta `ceopet/apps/legado/Hidra/fontes/`).
...
| OneDrive | Evitar executar direto de ceopet/apps/legado/Hidra — usar C:\Hidra |

### Procedimento

powershell -ExecutionPolicy Bypass -File ceopet/apps/legado/_tools\setup_hidra.ps1
cd C:\Hidra
.\scd.exe
...
- ceopet/apps/legado/Hidra/ind_emit.cdx
- Pastas Remessa/, Retorno/, Lixeira/, Saidatxt/
- ceopet/apps/legado/_tools/setup_hidra.ps1

## Histórico

| Data | Evento |
|------|--------|
| 2026-06-01 | Mapeamento inicial automatizado + estrutura RN criada a partir de `ceopet/apps/legado/Hidra/` |
